...
void setup_scr_Set(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->Set_btn_1, 9, 8);
    lv_obj_set_size(ui->Set_btn_1, 63, 21);
    ...
    lv_obj_set_style_text_font(ui->Set_btn_1, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Set_cont_1, 18, 62);
    lv_obj_set_size(ui->Set_cont_1, 200, 50);
    ...
    lv_obj_set_style_bg_opa(ui->Set_cont_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Set_cont_1, lv_color_hex(0x161616), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Set_label_1, 66, 16);
    lv_obj_set_size(ui->Set_label_1, 77, 17);
    ...
    lv_obj_set_style_text_font(ui->Set_label_1, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Set_cont_2, 23, 16);
    ...
    lv_obj_set_style_border_color(ui->Set_cont_2, lv_color_hex(0x686868), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Set_cont_3, 18, 130);
    lv_obj_set_size(ui->Set_cont_3, 200, 50);
    ...
    lv_obj_set_style_bg_opa(ui->Set_cont_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Set_cont_3, lv_color_hex(0x161616), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Set_label_2, 66, 16);
    lv_obj_set_size(ui->Set_label_2, 77, 17);
    ...
    lv_obj_set_style_text_font(ui->Set_label_2, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Set_cont_4, 23, 16);
    ...
    lv_obj_set_style_border_color(ui->Set_cont_4, lv_color_hex(0x686868), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Set_cont_5, 18, 200);
    lv_obj_set_size(ui->Set_cont_5, 200, 50);
    ...
    lv_obj_set_style_bg_opa(ui->Set_cont_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Set_cont_5, lv_color_hex(0x161616), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Set_label_3, 66, 16);
    lv_obj_set_size(ui->Set_label_3, 77, 17);
    ...
    lv_obj_set_style_text_font(ui->Set_label_3, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Set_cont_6, 23, 16);
    ...
    lv_obj_set_style_border_color(ui->Set_cont_6, lv_color_hex(0x686868), LV_PART_MAIN|LV_STATE_DEFAULT);
