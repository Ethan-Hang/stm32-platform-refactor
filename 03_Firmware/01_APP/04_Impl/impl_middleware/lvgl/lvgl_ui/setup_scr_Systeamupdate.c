...
void setup_scr_Systeamupdate(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->Systeamupdate_btn_1, 9, 8);
    lv_obj_set_size(ui->Systeamupdate_btn_1, 63, 21);
    ...
    lv_obj_set_style_text_color(ui->Systeamupdate_btn_1, lv_color_hex(0xffc700), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Systeamupdate_btn_1, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->Systeamupdate_img_1, &_syteam32x32_alpha_32x32_ext);
    lv_img_set_pivot(ui->Systeamupdate_img_1, 50,50);
    lv_img_set_angle(ui->Systeamupdate_img_1, 0);
    lv_obj_set_pos(ui->Systeamupdate_img_1, 42, 52);
    ...
    lv_obj_set_pos(ui->Systeamupdate_label_1, 82, 58);
    lv_obj_set_size(ui->Systeamupdate_label_1, 131, 21);
    ...
    lv_obj_set_style_text_font(ui->Systeamupdate_label_1, &lv_font_interttf_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->Systeamupdate_label_2, "现在进行版本检测，请确认在连接局域网环境下进行");
    lv_label_set_long_mode(ui->Systeamupdate_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Systeamupdate_label_2, 32, 123);
    lv_obj_set_size(ui->Systeamupdate_label_2, 179, 32);
    ...
    lv_obj_set_style_text_color(ui->Systeamupdate_label_2, lv_color_hex(0x565656), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Systeamupdate_label_2, &lv_font_alimama_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Systeamupdate_label_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Systeamupdate_btn_2, 42, 191);
    lv_obj_set_size(ui->Systeamupdate_btn_2, 175, 50);

    //Write style for Systeamupdate_btn_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->Systeamupdate_btn_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Systeamupdate_btn_2, lv_color_hex(0x242424), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->Systeamupdate_btn_2, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
