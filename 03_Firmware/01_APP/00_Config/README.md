...
| 文件 | 内容 |
|---|---|
| `inc/cfg_storage.h` | W25Q64 分区布局：LVGL 分区起点 `MEMORY_LVGL_START_ADDRESS=0x300000`、OTA staging 起点 `MEMORY_OTA_START_ADDRESS=0x000000`、各 LVGL 资源 offset/size（fen / miao / time / biaopan1）+ asset magic `0xA55A5AAA` |
